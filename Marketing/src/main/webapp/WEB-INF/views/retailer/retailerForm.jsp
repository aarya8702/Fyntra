...
<body>
	...
	<div class="container" style="margin-top: 100px;">
		...
		<form:form class="well form-horizontal" action="${saveUrl }"
			method="post" modelAttribute="retailerForm">
			...
			<div class="form-group">
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						...
						<form:input path="user.email" required="required"
			...
			<div class="form-group">
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						...
						<form:input id="txtNewPassword" required="required"
							path="user.password" placeholder="Password" class="form-control"
							type="password" />
					</div>
				</div>
			</div>
