...
<head>
  ...
  <link rel="shortcut icon" href="<c:url value='/resources/assets/images/mbr-122x122.jpg'></c:url>" type="image/x-icon">
  <meta name="description" content="Product Update">
  <title>Fytnra: Home</title>
  <link rel="stylesheet" href="<c:url value='/resources/assets/web/assets/mobirise-icons-bold/mobirise-icons-bold.css'></c:url>">
  ...
  <link rel="stylesheet" href="<c:url value='/resources/assets/animatecss/animate.min.css'></c:url>">
...
<jsp:include page="/WEB-INF/views/common/header.jsp"/>
	...
	<a href="https://mobiri.se/u">bootstrap html templates</a></section>
	<section class="carousel slide cid-r6tDDxcjr4" data-interval="false"
		id="slider1-1n">
	...
	<div class="full-screen">
		<div class="mbr-slider slide carousel" data-pause="true"
			...
			<ol class="carousel-indicators">
				<li data-app-prevent-settings="" data-target="#slider1-1n"
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item slider-fullscreen-image active"
					...
					style="background-image: url(<c:url value='/resources/images/carousel 1.jpg'></c:url>);">
				...
				<div class="carousel-item slider-fullscreen-image"
					...
					<div class="container container-slide">
						<div class="image_wrapper">
							<img src="<c:url value='/resources/images/carousel2.jpg'></c:url> " style="opacity: 0;">
							<div class="carousel-caption justify-content-center">
				...
				<div class="carousel-item slider-fullscreen-image"
					data-bg-video-slide="false"
					style="background-image: url(<c:url value='/resources/images/carousel 3.jpg'></c:url>);">
					<div class="container container-slide">
						<div class="image_wrapper">
							<div class="mbr-overlay"></div>
			...
			<a data-app-prevent-settings=""
				...
				data-slide="prev" href="#slider1-1n"><span aria-hidden="true"
				...
				data-slide="next" href="#slider1-1n"><span aria-hidden="true"
	...
	<section class="cid-r6u1QCYn23 mbr-fullscreen mbr-parallax-background"
		id="header2-1o">
		...
		<div class="row justify-content-md-center">
			<div class="mbr-white col-md-10">
				...
				<p class="mbr-text pb-3 mbr-fonts-style display-5">Click any
					...
					"Gear" icon in the top right corner to hide/show buttons, text,
					title and change the block background. Click red "+" in the bottom
				...
				<div class="mbr-section-btn">
					<a class="btn btn-md btn-secondary display-4"
						href="https://mobirise.com">LEARN MORE</a> <a
						class="btn btn-md btn-white-outline display-4"
						href="https://mobirise.com">LIVE DEMO</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section
		class="mbr-section form3 cid-r6u6obga0q mbr-parallax-background"
		id="form3-1s">
			...
			<div class="col-12 col-lg-6  col-md-8 " data-form-type="formoid">
				...
				<form class="mbr-form" action="https://mobirise.com/" method="post"
					...
					<input type="hidden" name="email" data-form-email="true"
						value="rcITOuu+1EbuIpSigizG3UAOvySbBW5bDuR/rppW/IH2AYNFUIOJMzmc+mYcMsejWLtsztKoz2nS2T/zV7MgKn72q/wptGr8b/cDwX9j7iBVuf91dR7kv5dAYL8fRQRp"
						data-form-field="Email">
					<div class="mbr-subscribe input-group">
						<input class="form-control" type="email" name="email"
							placeholder="Search Nearby Promotions" data-form-field="Email"
							required="" id="email-form3-1s"> <span
							class="input-group-btn"><button href="" type="submit"
	...
	<section class="cid-r51EeXKTic" id="pricing-tables1-1j">
		...
		<div class="media-container-row">
				...
				<div class="plan-header text-center pt-5">
					...
					<div class="plan-price">
						<span class="price-value mbr-fonts-style display-5"> $ </span> <span
							class="price-figure mbr-fonts-style display-1"> 35</span> <small
							class="price-term mbr-fonts-style display-7"> per month </small>
					</div>
				</div>
				<div class="plan-body pb-5">
					<div class="plan-list align-center">
						<ul class="list-group list-group-flush mbr-fonts-style display-7">
							<li class="list-group-item">Mobirise is perfect for
								non-techies who are not familiar with web development.</li>
							<li class="list-group-item">5 GB Bandwidth</li>
						</ul>
					</div>
					<div class="mbr-section-btn text-center pt-4">
						<a href="https://mobirise.com" class="btn btn-primary display-4">Browse
							More</a>
					</div>
				</div>
			</div>
			...
			<div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
				<div class="plan-header text-center pt-5">
					...
					<div class="plan-price">
						<span class="price-value mbr-fonts-style display-5"> $ </span> <span
							class="price-figure mbr-fonts-style display-1"> 65</span> <small
							class="price-term mbr-fonts-style display-7"> per day </small>
					</div>
				</div>
				<div class="plan-body pb-5">
					<div class="plan-list align-center">
			...
			<div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
				<div class="plan-header text-center pt-5">
					...
					<div class="plan-price">
						<span class="price-value mbr-fonts-style display-5"> $ </span> <span
							class="price-figure mbr-fonts-style display-1"> 90</span> <small
							class="price-term mbr-fonts-style display-7"> per year </small>
					</div>
				</div>
				<div class="plan-body pb-5">
					<div class="plan-list align-center">
			...
			<div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
				<div class="plan-header text-center pt-5">
					<h3 class="plan-title mbr-fonts-style display-5">Ultimate</h3>
					<div class="plan-price">
						<span class="price-value mbr-fonts-style display-5"> $ </span> <span
							class="price-figure mbr-fonts-style display-1"> 150</span> <small
							class="price-term mbr-fonts-style display-7"> per hour </small>
					</div>
				</div>
				<div class="plan-body pb-5">
					<div class="plan-list align-center">
	...
	<script src="<c:url value='/resources/assets/viewportchecker/jquery.viewportchecker.js'></c:url>"></script>
	<script src="<c:url value='/resources/assets/ytplayer/jquery.mb.ytplayer.min.js'></c:url>"></script>
	<script src="<c:url value='/resources/assets/vimeoplayer/jquery.mb.vimeo_player.js'></c:url>"></script>
	<script src="<c:url value='/resources/assets/bootstrapcarouselswipe/bootstrap-carousel-swipe.js'></c:url>"></script>
	...
	<script src="<c:url value='/resources/assets/slidervideo/script.js'></c:url>"></script>
	<script src="<c:url value='/resources/assets/formoid/formoid.min.js'></c:url>"></script>
