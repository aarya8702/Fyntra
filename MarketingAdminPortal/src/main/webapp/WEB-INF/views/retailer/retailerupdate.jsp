...
<body bgcolor="grey">
	<div class="container">
		<div class = "row">
		<spring:url value="/admin/retailer/update" var="saveUrl" />
		<form:form action="${saveUrl }" method="post" class = "form-horizontal" modelAttribute="retailer">
			...
			<div class="form-group">
				...
				<div class = "col-md-8">
				<form:input id = "password" type="password" path="user.password" class="form-control"
					placeholder="Enter Password" readonly = "true"/>
				</div><button type = "button" class = "btn btn-secondary" onclick="myFunction()">change</button>
			</div>
			<div class="form-group">
			...
			<div class = "col-md-8">
			 <button type= "submit" class = "btn btn-success">Update Retailer</button>
			 <a class = "btn btn-danger" href = "<c:url value = '/admin/retailer/list'></c:url>">Cancel</a>
			</div>
			</div>
					</fieldset>
		</form:form>
