...
<jsp:include page = "/WEB-INF/views/common/header.jsp"/>
	<div class="container" style="margin-top: 100px;">
		...
		<form:form class="well form-horizontal" action="${saveUrl }" method="post" modelAttribute="customerForm">
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							<form:input path="user.email" placeholder="Email Address" required="required" class="form-control" type="email"/>
					</div>
				</div>
			</div>
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							<form:input id="txtNewPassword" path="user.password" required="required" placeholder="Password" class="form-control" type="password"/>
					</div>
				</div>
			</div> 			
             <div class="form-group">
