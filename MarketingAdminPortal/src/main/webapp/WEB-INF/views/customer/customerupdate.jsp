...
<body bgcolor="grey">
	<div class="container">
		<div class = "row">
		<spring:url value="/admin/customer/update" var="saveUrl" />
		<form:form action="${saveUrl }" method="post" class = "form-horizontal" modelAttribute="customer">
			<form:hidden path="custId" />
			<fieldset>
					<legend class="center-block">
						Update Customer Information<span style="font-size: small"> * is a
							required field</span>
					</legend>
